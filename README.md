...
- Custom glowing cursor, animated grain texture, particle constellation hero
- Typewriter role cycle, masked headline reveal, scroll-triggered animations
- Glassmorphism project cards with cursor-tracking spotlights
- Magnetic buttons, glossy hover sweeps, animated count-up stats
...
(name, bio, projects, email, social links). The share image is `og-cover.png` (1200×630).
